...
<section class="mb-4">
    <div class="container">
        <div>
            <h5 class="text-uppercase h5 mt-5 mb-3 text-center">{{ translate('Handpicked for you') }}</h5>
        </div>
        <div class="nav filters-button-group text-uppercase mb-3 mb-md-4 mobile-hor-swipe d-block d-md-flex justify-content-center align-items-center" >
            ...
            @foreach ($home_categories as $key => $value)
                ...
                @if($category != null)
                <a class="bg-transparent border-0 button fw-500 px-3 py-2 text-uppercase text-reset fs-12 opacity-70" data-toggle="tab" href="#category-{{ $category->id }}">
                    <div class="d-flex flex-column align-items-center" >
                            <div class="img-back  bg-alter-2  d-flex align-items-center justify-content-center my-2">
