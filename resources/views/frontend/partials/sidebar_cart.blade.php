            ...
            <div class="cart-item d-flex align-items-center">
                ...
                <div class="flex-grow-1 minw-0">
                    ...
                    <div class="row no-gutters align-items-center aiz-plus-minus w-120px">
                        <button class="btn col-auto btn-icon btn-sm btn-light" type="button" data-type="minus" data-field="quantity[{{ $cartItem['id'] }}]" style="width: 30px;height: 30px;padding: 5px;">
                        ...
                        <button class="btn col-auto btn-icon btn-sm btn-light" type="button" data-type="plus" data-field="quantity[{{ $cartItem['id'] }}]" style="width: 30px;height: 30px;padding: 5px;">
