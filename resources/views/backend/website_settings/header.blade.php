			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Topbar Logo') }}</label>
                        <div class="col-md-8">
					...
					<div class="border-bottom pb-3 mb-3">
						<label class="">{{translate('Topbar Nav Menu')}}</label>
						<div class="topbar-nav-menu">
							...
							@if (get_setting('topbar_menu_labels') != null)
								@foreach (json_decode( get_setting('topbar_menu_labels'), true) as $key => $value)
									<div class="row gutters-5">
										<div class="col-4">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Label" name="topbar_menu_labels[]" value="{{ $value }}">
											</div>
										</div>
										<div class="col">
											<div class="form-group">
												<input type="text" class="form-control" placeholder="{{ translate('Link with') }} http:// {{ translate('or') }} https://" name="topbar_menu_links[]" value="{{ json_decode(App\BusinessSetting::where('type', 'topbar_menu_links')->first()->value, true)[$key] }}">
											</div>
										</div>
										<div class="col-auto">
						...
						<button
							...
							data-content='<div class="row gutters-5">
								...
								<div class="col">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="{{ translate('Link with') }} http:// {{ translate('or') }} https://" name="topbar_menu_links[]">
									</div>
								</div>
								<div class="col-auto">
									<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
