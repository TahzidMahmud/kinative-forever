                        ...
                        <div class="position-relative mb-3">
                            ...
                            <div class="row align-items-center z-1 absolute-full">
                                ...
                                <div class="col">
                                    ...
                                    <a href="{{ json_decode(get_setting('home_branch_link'))[$key] }}" target="_blank" class="fw-700 text-alter">{{ translate('VIEW ON MAP') }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<footer class="pt-4 pb-8 py-xl-4 bg-alter-2 text-white">
    <div class="container">
