		...
		<div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="subsidiaries-target">
                    ...
                    <input type="hidden" name="types[]" value="subsidiaries">
                </div>
                @if (get_page_setting('subsidiaries_images',$page->id) != null)
                    @foreach (json_decode(get_page_setting('subsidiaries_images',$page->id), true) as $key => $value)
                    	<div class="row gutters-5">
                            ...
                            <div class="col-xl">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="{{ translate('http://') }}" name="subsidiaries_links[]" value="{{ json_decode(get_page_setting('subsidiaries_links',$page->id),true)[$key] }}">
                                </div>
                            </div>
                            <div class="col-auto">
                                <button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
