...
<ul class="nav nav-tabs nav-fill border-light">
    @foreach (\App\Language::all() as $key => $language)
        <li class="nav-item">
            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('website.header', ['lang'=> $language->code] ) }}">
			...
			<div class="card">
				...
				<div class="card-body">
                    <div class="form-group">
						...
						<input type="hidden" name="types[][{{ $lang }}]" value="topbar_left">
						<input type="text" class="form-control" placeholder="" name="topbar_left" value="{{ get_setting('topbar_left', null, $lang) }}">
					</div>
                    <div class="form-group">
						<label>{{ translate('Center Text') }}</label>
						<input type="hidden" name="types[][{{ $lang }}]" value="topbar_center">
						<input type="text" class="form-control" placeholder="" name="topbar_center" value="{{ get_setting('topbar_center', null, $lang) }}">
					</div>
				</div>
			</div>
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="border-top pt-3">
						...
						<div class="header-nav-menu">
							<input type="hidden" name="types[][{{ $lang }}]" value="header_menu_labels">
