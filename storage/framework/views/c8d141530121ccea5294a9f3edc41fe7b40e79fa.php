...
<section class="mb-4">
    <div class="container">
        <div>
            <h6 class=" h5 mt-5 mb-3 text-center"><?php echo e(translate('Handpicked
            For You')); ?></h6>
        </div>
        <div class="nav filters-button-group tst text-uppercase mb-3 mb-md-4 mobile-hor-swipe d-md-flex justify-content-center align-items-center tts" >
            ...
            <?php $__currentLoopData = $home_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a class="bg-transparent tts border-0 button fw-500 px-3 py-2 text-uppercase text-reset fs-12 opacity-70" data-toggle="tab" href="#category-<?php echo e($category->id); ?>">
                    <div class="d-flex flex-column align-items-center" >
                            <div class="img-back  bg-alter-2  d-flex align-items-center justify-content-center tts my-2">
        ...
        <div class="tab-content  ttb" >
            <div class="tab-pane fade show active" id="all-category" >
                <div class="row row-cols-xxl-6 row-cols-lg-5 row-cols-md-4 row-cols-sm-3 row-cols-2 gutters-5">
                    <?php $__currentLoopData = \App\Product::where('published', '1')->where('featured', '1')->inRandomOrder()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col mb-2">
                        <?php echo $__env->make('frontend.partials.product_box_3',['product'=>$product], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
                ...
                <?php if($category != null): ?>
                    <div class="tab-pane fade" id="category-<?php echo e($category->id); ?>" >
                        <div class="row row-cols-xl-6 row-cols-lg-5 row-cols-md-4 row-cols-sm-3 row-cols-2 gutters-5">
                            ...
                            <div class="col mb-2">
                                <?php echo $__env->make('frontend.partials.product_box_2',['product'=>$product,'type'=>'handpick','cati'=>$category->slug], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
