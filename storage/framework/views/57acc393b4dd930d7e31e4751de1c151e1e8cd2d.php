        ...
        <div class="row align-items-center">
            ...
            <div class="col-6 col-lg-3 d-flex justify-content-end">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center d-flex justify-content-between align-items-center">
                    <li  class="list-inline-item   d-none d-lg-block "> <a href="<?php echo e(get_setting('topbar_about_us')); ?>" class="text-white mx-1">About Us</a> </li>

                    <li  class="list-inline-item "><a href="<?php echo e(get_setting('store_location')); ?>" class="text-white">Store Locations</a></li>

                    <li  class="list-inline-item  d-none d-lg-block mr-0 "><a href="<?php echo e(get_setting('topbar_contact')); ?>" class="text-white">Contact </a></li>
